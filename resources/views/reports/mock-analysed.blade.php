...
<body>
    ...
    <div class="sheet">
        <div class="box">
            ...
            <div class="box-meta">{{ strtoupper($schoolName) }} &nbsp; {{ strtoupper($schoolDistrict) }} &nbsp; NA</div>
            <div class="box-title">
                {{ $category === 'UACE' ? 'UACE MOCK ANALYSED REPORT' : ($category === 'PLE' ? 'PLE MOCK ANALYSED REPORT' : 'UCE MOCK ANALYSED REPORT') }}
            </div>
            ...
            <table class="analysed-table">
                ...
                <tbody>
                    @foreach($students as $i => $student)
                        <tr>
                            <td>{{ $i + 1 }}</td>
                            <td class="name-col">{{ strtoupper($student['name']) }}</td>
                            <td>NA</td>
                            @if($category === 'UACE')
