                ...
                <div class="card shadow-sm" style="border-top: 4px solid #026837; border-radius: 10px;">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center"
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="ms-2">
                                <h5 class="mb-0 text-white fw-semibold">Edit School</h5>
                                <small class="text-white" style="font-size:11px;">Update school information</small>
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <div style="margin-top: 6px;">
                                    <span style="color: #667788; font-size: 11px;">
                                        <i class="fas fa-info-circle" style="font-size: 10px;"></i> Registration Code
                                    </span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                    ...
                                    <label for="categoryNoAnswers"
                                        ...
                                        <input type="radio" name="Category" id="categoryNoAnswers" value="No Answer Sheets"
                                            style="display: none;" {{ old('Category', $school->category) == 'No Answer Sheets' ? 'checked' : '' }}>
                                        <div
                                            style="padding: 20px; border: 2px solid {{ old('Category', $school->category) == 'No Answer Sheets' ? '#e74c3c' : '#e2e8f0' }}; border-radius: 12px; background: {{ old('Category', $school->category) == 'No Answer Sheets' ? '#fdf2f2' : 'transparent' }}; text-align: center; transition: all 0.3s ease;">
        ...
        $(document).ready(function() {
            $('#updateSchoolForm').on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    html: '<span style="color:#555;">You are about to update <strong>'
                    ...
                    if (result.isConfirmed) {
                        ...
                        $btn.prop('disabled', true)
                            .html('Updating… <i class="fas fa-spinner fa-spin ms-1"></i>');
