...
<aside class="app-sidebar app-sidebar3">
    <ul class="side-menu">
        ...
        @if (!Session('LoggedSchool') && $__loggedInMarksEntrant)
            {{-- Marks entrants are restricted admin accounts: only the Enter
                 Marks screen is relevant to them, everything else on the
                 admin side is hidden. See StudentAuth middleware for the
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('notifications.inbox') }}">
                    <i class="fa fa-inbox fa-2x mr-3"></i>
                    My Inbox
                    @php $adminUnread = \App\Http\Controllers\Helper::adminUnreadBroadcastCount(); @endphp
                    @if ($adminUnread > 0)
                        <span class="badge badge-danger ml-2">{{ $adminUnread }}</span>
                    @endif
                </a>
            </li>
        @elseif (!Session('LoggedSchool'))
            ...
            <li class="slide has-sub">
                ...
                <ul class="sub-menu">
                    <li><a href="{{ route('students.individual.search') }}"><i class="fas fa-search me-2"></i>Search
                            Student</a></li>
                    <li><a href="{{ route('students.add.new.student') }}"><i class="fas fa-user-plus me-2"></i>Add
                            Students</a></li>
                    <li><a href="{{ route('students.all.students') }}"><i class="fas fa-users me-2"></i>All Students</a>
                    </li>
                    ...
                    <!-- <li>
                        <a href="{{ route('admin.student.approvals') }}">
                            ...
                            @if($pendingApprovalCount > 0)
                                <span class="badge badge-danger ml-2">{{ $pendingApprovalCount }}</span>
                            @endif
                        </a>
                    </li> -->

                    <!-- <li><a href="{{ route('passlip.generate') }}"><i class="fas fa-scroll me-3"></i>Passlips &
                            Certificates</a></li> -->
            ...
            <li class="slide has-sub">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="{{ route('system-users.index') }}"><i class="fas fa-user-check mr-2"></i>Marks
            ...
            <li class="slide has-sub">
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="{{ route('grading.settings') }}">
                            <i class="fas fa-percent me-2"></i>Grading Settings
                        </a>
                    </li>
                    <li><a href="{{ url('iteb/grading-summary') }}"><i class="fa-solid fa-chart-column me-2"></i></i>Grading
                            Summary</a></li>
                </ul>
            </li>
            ...
            <li class="slide has-sub">
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="{{ route('subject.management.index') }}">
                    ...
                    <li>
                        <a href="{{ route('combination.management.index') }}">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('reports.dashboard') }}">
        ...
        @if (!Session('LoggedStudent'))
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('school.reports.dashboard') }}">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('school.messages.index') }}">
                    <i class="fa fa-inbox fa-2x mr-3"></i>
                    Messages
                    @php $schoolUnread = \App\Http\Controllers\Helper::schoolUnreadBroadcastCount(); @endphp
                    @if ($schoolUnread > 0)
                        <span class="badge badge-danger ml-2">{{ $schoolUnread }}</span>
                    @endif
                </a>
            </li>
...
function submitPasswordUpdate($btn, currentPassword, newPassword) {
    ...
    $.ajax({
        ...
        data: {
            ...
            school_id: '{{ Session::get("LoggedSchool") }}'
        },
