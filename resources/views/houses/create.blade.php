                            ...
                            <div id="categorySelectionContainer"
                                ...
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                    <label for="categoryAnswers"
                                        ...
                                        <div
                                            style="padding: 20px; border: 2px solid {{ old('Category') == 'Answer Sheets' ? '#043AA1' : '#e2e8f0' }}; border-radius: 12px; background: {{ old('Category') == 'Answer Sheets' ? '#f0fdf4' : 'transparent' }}; text-align: center; transition: all 0.3s ease;">
