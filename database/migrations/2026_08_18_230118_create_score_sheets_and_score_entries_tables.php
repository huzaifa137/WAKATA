 ...
 *
 * Backs the new "Scan & Export Score Sheet" admin page. Unlike the
 * ScoreScanController used on the Enter Marks screen (which never touches
 * the DB and only fills the marks form directly), this feature persists
 * scanned/edited rows so a school's raw score sheet can be revisited and
 * re-exported to Excel later from the "Recent Imports" list.
 */
