                                    ...
                                    <div class="input-group">
                                        <select id="schoolSelect" class="form-control select2" required>
                                            ...
                                            <?php $__currentLoopData = $houses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $house): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($house->ID); ?>"><?php echo e($house->House); ?> -
                                                    <?php echo e($house->Number); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#fetchPasswordBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo e(route('school.passwords.fetch')); ?>',
                type: 'POST',
                data: {
                    school_id: schoolId,
        ...
        $('#regenerateBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo e(route('school.passwords.generate')); ?>',
                type: 'POST',
                data: {
        ...
        $('#savePasswordBtn').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('school.passwords.save')); ?>',
                        type: 'POST',
                        data: {
                            school_id: currentSchoolId,
        ...
        $('#exportAllPasswordsBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo e(route('school.passwords.export-all-pdf')); ?>',
                type: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>'
                },
...
<?php echo $__env->make('layouts-side-bar.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u453625278/domains/kamssamock.com/public_html/resources/views/itemGrading/school-passwords-setup.blade.php ENDPATH**/ ?>