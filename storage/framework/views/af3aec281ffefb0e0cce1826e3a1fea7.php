...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="school_number" id="reportSchool" class="form-control" required>
                                    ...
                                    <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($school->Number); ?>"><?php echo e($school->House); ?> (<?php echo e($school->Number); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        <?php else: ?>
                            <input type="hidden" name="school_number" value="<?php echo e($lockedSchoolNumber); ?>">
    ...
    <script>
        const REPORT_ROUTES = {
            passlip: "<?php echo e($portal === 'bureau' ? route('reports.mock.passlip') : route('school.reports.mock.passlip')); ?>",
            subjectslip: "<?php echo e($portal === 'bureau' ? route('reports.mock.subjectslip') : route('school.reports.mock.subjectslip')); ?>",
            analysed: "<?php echo e($portal === 'bureau' ? route('reports.mock.analysed') : route('school.reports.mock.analysed')); ?>",
        };
        const REPORT_TITLES = {
        ...
        const STUDENTS_FOR_SCHOOL_URL = "<?php echo e($portal === 'bureau' ? route('reports.students.for.school') : route('school.reports.students.for.school')); ?>";
        const PORTAL = <?php echo json_encode($portal, 15, 512) ?>;
        const LOCKED_SCHOOL_NUMBER = <?php echo json_encode($lockedSchoolNumber, 15, 512) ?>;
...
<?php echo $__env->make('layouts-side-bar.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u453625278/domains/kamssamock.com/public_html/resources/views/reports/dashboard.blade.php ENDPATH**/ ?>