            ...
            <div class="col-lg-12">
                <div class="card bg-primary">
                    <div class="card-header">
                        <?php echo $__env->make('layouts.subjects-buttons', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12 col-xl-12 col-md-10 col-sm-12 mx-auto">
                <div class="card shadow-sm" style="border-top: 4px solid #026837; border-radius: 10px;">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center"
                        ...
                        <a href="<?php echo e(url('all-schools')); ?>" class="btn btn-sm text-white"
                    ...
                    <div class="card-body" style="background: #ffffff; border-radius: 0 0 20px 20px; padding: 0;">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <span
                                        ...
                                        IT-<?php echo e(str_pad($nextNumber, 3, '0', STR_PAD_LEFT)); ?>
                        ...
                        <form id="createHouseForm" method="POST" action="<?php echo e(route('houses.store')); ?>"
                                ...
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                    <div>
                                        ...
                                        <input type="text" name="House" id="House"
                                            class="form-control <?php $__errorArgs = ['House'];
...
unset($__errorArgs, $__bag); ?>"
                                            placeholder="Type school name..." value="<?php echo e(old('House')); ?>" required
...
$message = $__bag->first($__errorArgs[0]); ?>
                                            <div style="color: #e74c3c; font-size: 12px; margin-top: 5px;"><?php echo e($message); ?></div>
                                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
unset($__errorArgs, $__bag); ?>"
                                            placeholder="Enter district..." value="<?php echo e(old('Location')); ?>" required
                                            style="width: 100%; padding: 12px 16px; border: 2px solid #e2e8f0; border-radius: 12px; font-size: 14px; background: white; transition: all 0.25s ease;"
                                            onfocus="this.style.borderColor='#026837'; this.style.boxShadow='0 0 0 4px rgba(0,208,132,0.08)'"
                                            onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none'">
                                ...
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                    <label for="categoryAnswers"
                                        ...
                                        <input type="radio" name="Category" id="categoryAnswers" value="Answer Sheets"
                                            style="display: none;" <?php echo e(old('Category') == 'Answer Sheets' ? 'checked' : ''); ?>>
                                        <div
                                            style="padding: 20px; border: 2px solid <?php echo e(old('Category') == 'Answer Sheets' ? '#026837' : '#e2e8f0'); ?>; border-radius: 12px; background: <?php echo e(old('Category') == 'Answer Sheets' ? '#f0fdf4' : 'transparent'); ?>; text-align: center; transition: all 0.3s ease;">
                                    ...
                                    <label for="categoryNoAnswers"
                                        ...
                                        <input type="radio" name="Category" id="categoryNoAnswers" value="No Answer Sheets"
                                            style="display: none;" <?php echo e(old('Category') == 'No Answer Sheets' ? 'checked' : ''); ?>>
                                        <div
                                            style="padding: 20px; border: 2px solid <?php echo e(old('Category') == 'No Answer Sheets' ? '#e74c3c' : '#e2e8f0'); ?>; border-radius: 12px; background: <?php echo e(old('Category') == 'No Answer Sheets' ? '#fdf2f2' : 'transparent'); ?>; text-align: center; transition: all 0.3s ease;">
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="AdministratorNames" id="AdministratorNames"
                                            class="form-control <?php $__errorArgs = ['AdministratorNames'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            value="<?php echo e(old('AdministratorNames')); ?>" required
                                            style="width: 100%; padding: 12px 16px; border: 2px solid #e2e8f0; border-radius: 12px; font-size: 14px; background: white; transition: all 0.25s ease;"
                                            onfocus="this.style.borderColor='#026837'; this.style.boxShadow='0 0 0 4px rgba(0,208,132,0.08)'"
                                            onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none'">
                                        <?php $__errorArgs = ['AdministratorNames'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="AdministratorTelephones" id="AdministratorTelephones"
                                            class="form-control <?php $__errorArgs = ['AdministratorTelephones'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            placeholder="e.g. 0712-345-678" value="<?php echo e(old('AdministratorTelephones')); ?>"
                                            required
                                            style="width: 100%; padding: 12px 16px; border: 2px solid #e2e8f0; border-radius: 12px; font-size: 14px; background: white; transition: all 0.25s ease;"
                                            onfocus="this.style.borderColor='#026837'; this.style.boxShadow='0 0 0 4px rgba(0,208,132,0.08)'"
                                            onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none'">
                                        <?php $__errorArgs = ['AdministratorTelephones'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div
                                ...
                                <a href="<?php echo e(url('schools/all')); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts-side-bar.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\KAMSSA\resources\views/houses/create.blade.php ENDPATH**/ ?>