    ...
    <div class="register-card">
        ...
        <div style="text-align: center; margin-bottom: 1.5rem;">
            <div style="
                        ...
                        background:#fff;
                    ">
                <img src="<?php echo e(asset('asset/images/logo.png')); ?>" alt="KAMSSA Logo"
        ...
        <div style="text-align:center; margin-bottom: 1.8rem;">
            ...
            <div>
                <span class="badge-ref">IT-<?php echo e(str_pad($nextNumber, 3, '0', STR_PAD_LEFT)); ?></span>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="House" id="House"
                            class="form-input <?php $__errorArgs = ['House'];
            ...
            <div class="grid-2" style="margin-bottom: 0.5rem;">
                <label for="categoryAnswers" class="category-option"
                    ...
                    <input type="radio" name="Category" id="categoryAnswers" value="Answer Sheets"
                        <?php echo e(old('Category') == 'Answer Sheets' ? 'checked' : ''); ?>>
                    <div class="category-card <?php echo e(old('Category') == 'Answer Sheets' ? 'selected' : ''); ?>">
                ...
                <label for="categoryNoAnswers" class="category-option"
                    ...
                    <input type="radio" name="Category" id="categoryNoAnswers" value="No Answer Sheets"
                        <?php echo e(old('Category') == 'No Answer Sheets' ? 'checked' : ''); ?>>
                    <div class="category-card category-negative <?php echo e(old('Category') == 'No Answer Sheets' ? 'selected' : ''); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="AdministratorNames" id="AdministratorNames"
                            class="form-input <?php $__errorArgs = ['AdministratorNames'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Enter administrator name..." value="<?php echo e(old('AdministratorNames')); ?>"
                            required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="AdministratorTelephones" id="AdministratorTelephones"
                            class="form-input <?php $__errorArgs = ['AdministratorTelephones'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="e.g. 0712-345-678" value="<?php echo e(old('AdministratorTelephones')); ?>" required>
                    </div>
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="e.g. Headteacher, Principal, Director..." value="<?php echo e(old('Title')); ?>"
                            required>
                    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-actions">
                ...
                <a href="<?php echo e(url('/users/login')); ?>" class="btn btn-primary" style="width: 100%; text-decoration: none;background-color: orange;">
            ...
            <a href="<?php echo e(url('/')); ?>" class="btn btn-secondary" style="width: 100%; text-decoration: none;">
...
</html><?php /**PATH /home/u453625278/domains/kamssamock.com/public_html/resources/views/users/school-register.blade.php ENDPATH**/ ?>