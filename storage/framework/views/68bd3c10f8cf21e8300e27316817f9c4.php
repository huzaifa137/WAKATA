        ...
        <div class="container-fluid mt-3">
            ...
            <div class="sd-hero">
                <div>
                    ...
                    <p>Grading &amp; examination overview for <?php echo e(session('LoggedSchoolName') ?? 'your school'); ?></p>
                </div>
                <div class="sd-badge">
                    <i class="fas fa-shield-halved me-1"></i>
                    <?php echo e(session('LoggedSchoolName') ?? 'School'); ?> &middot; <?php echo e(session('LoggedSchoolCode')); ?>
            ...
            <div class="row g-3 mb-4">
                <div class="col-6 col-lg-3">
                    <div class="sd-stat">
                        ...
                        <div>
                            <div class="sd-number"><?php echo e(number_format($totalStudents ?? 0)); ?></div>
                ...
                <div class="col-6 col-lg-3">
                    <div class="sd-stat">
                        ...
                        <div>
                            <div class="sd-number"><?php echo e(number_format($gradedSoFar ?? 0)); ?></div>
                ...
                <div class="col-6 col-lg-3">
                    <div class="sd-stat">
                        ...
                        <div>
                            <div class="sd-number"><?php echo e(number_format($pendingGrading ?? 0)); ?></div>
                ...
                <div class="col-6 col-lg-3">
                    <div class="sd-stat">
                        ...
                        <div>
                            <div class="sd-number"><?php echo e(number_format($avgPerformance ?? 0, 1)); ?>%</div>
            ...
            <div class="sd-card">
                ...
                <div class="sd-card-body">
                    <form action="<?php echo e(route('school.process.grading')); ?>" method="POST" id="gradingFilterForm">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select name="year" class="form-select select2" required>
                                    ...
                                    <?php $__currentLoopData = $academicYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $academicYear): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($academicYear->year_en); ?>" <?php echo e($academicYear->year_en == $activeYear ? 'selected' : ''); ?>>
                                            <?php echo e($academicYear->year_en); ?>
...
<?php echo $__env->make('layouts-side-bar.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u453625278/domains/kamssamock.com/public_html/resources/views/GeneralSchools/dashboard.blade.php ENDPATH**/ ?>