                                ...
                                <tbody>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-start"><?php echo e($user->firstname); ?> <?php echo e($user->lastname); ?></td>
                                            <td><?php echo e($user->username); ?></td>
                                            <td><?php echo e($user->email); ?></td>
                                            <td>
                                                <span class="role-pill <?php echo e($isEntrant ? 'marks_entrant' : 'administrator'); ?>">
                                                    <?php echo e($isEntrant ? 'Marks Entrant' : 'Administrator'); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <?php if($isEntrant): ?>
                                                    <span class="badge bg-info text-white"><?php echo e($user->mark_assignments_count); ?>
                                            ...
                                            <td>
                                                <span class="active-pill <?php echo e($user->is_active ? 'active' : 'inactive'); ?>">
                                            ...
                                            <td class="text-nowrap">
                                                <button type="button" class="btn btn-outline-dark btn-sm" title="Edit"
                                                    onclick='suOpenEditModal(<?php echo json_encode($user, 15, 512) ?>, <?php echo json_encode($userAssignments->values(), 15, 512) ?>)'>
                                                    <i class="fa fa-pen"></i>
                                                </button>
                                                <button type="button"
                                                    class="btn btn-sm <?php echo e($user->is_active ? 'btn-outline-secondary' : 'btn-outline-success'); ?>"
                                                    title="<?php echo e($user->is_active ? 'Deactivate' : 'Activate'); ?>"
                                                    onclick="suToggleStatus(<?php echo e($user->id); ?>, this)">
                                                    <i class="fa <?php echo e($user->is_active ? 'fa-eye-slash' : 'fa-eye'); ?>"></i>
                                                </button>
                                                <button type="button" class="btn btn-outline-danger btn-sm" title="Delete"
                                                    onclick="suDelete(<?php echo e($user->id); ?>, '<?php echo e(addslashes($user->firstname . ' ' . $user->lastname)); ?>')">
    ...
    <div class="modal fade" id="createUserModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form method="POST" action="<?php echo e(route('system-users.store')); ?>" id="createUserForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="createAssignmentWrapper" style="display:none;">
                            ...
                            <?php echo $__env->make('marks-entrants.partials.assignment-picker', ['prefix' => 'create'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
                ...
                <form method="POST" id="editUserForm" action="">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="editAssignmentWrapper" style="display:none;">
                            <label class="fw-bold">Assign Subjects &amp; Papers</label>
                            <?php echo $__env->make('marks-entrants.partials.assignment-picker', ['prefix' => 'edit'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Cancel</button>
...
<?php echo $__env->make('layouts-side-bar.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u453625278/domains/kamssamock.com/public_html/resources/views/marks-entrants/index.blade.php ENDPATH**/ ?>