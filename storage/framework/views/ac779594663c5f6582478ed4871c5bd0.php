        ...
        <div class="container-fluid mt-3">
            ...
            <div class="card shadow-lg border-0">
                <div class="card-header text-white d-flex justify-content-between align-items-center flex-wrap gap-2"
                    ...
                    <div class="d-flex">
                        <a href="<?php echo e(route('notifications.inbox')); ?>"
                ...
                <div class="card-body">
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            <?php endif; ?>
                            <?php if(session('fail')): ?>
                                Swal.fire({ icon: 'error', title: 'Error', text: <?php echo json_encode(session('fail'), 15, 512) ?>, confirmButtonColor: '#d33' });
                            <?php endif; ?>
                            <?php if($errors->any()): ?>
                                Swal.fire({ icon: 'error', title: 'Please check the form', html: `<?php echo implode('<br>', $errors->all()); ?>`, confirmButtonColor: '#d33' });
                            <?php endif; ?>
                            });
                    </script>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="subject-cell text-start"><strong><?php echo e($message->subject); ?></strong></td>
                                            <td class="excerpt-cell text-start"><?php echo e($message->excerpt); ?></td>
                                            <td>
                                                <span
                                                    class="priority-pill <?php echo e($message->priority); ?>"><?php echo e($message->priority_label); ?></span>
                                            </td>
                                            <td><span class="audience-pill"><?php echo e($message->audience_label); ?></span></td>
                                            <td><?php echo e(optional($message->sender)->firstname); ?>

                                                <?php echo e(optional($message->sender)->lastname); ?></td>
                                            <td class="text-nowrap"><?php echo e($message->created_at->format('d M Y, h:i A')); ?></td>
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="read-progress"><span style="width:<?php echo e($readPct); ?>%;"></span></div>
                                                    <small
                                                        class="text-muted"><?php echo e($message->read_count); ?>/<?php echo e($message->recipients_count); ?></small>
                                                </div>
                                            </td>
                                            <td class="text-nowrap">
                                                <a href="<?php echo e(route('notifications.show', $message->id)); ?>"
                                                    class="btn btn-outline-dark btn-sm" title="View details">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <button type="button" class="btn btn-outline-danger btn-sm" title="Delete"
                                                    onclick="nbDeleteMessage(<?php echo e($message->id); ?>, '<?php echo e(addslashes($message->subject)); ?>')">
    ...
    <div class="modal fade" id="composeMessageModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <form method="POST" action="<?php echo e(route('notifications.store')); ?>" id="composeMessageForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo $__env->make('broadcast-messages.partials.recipient-picker', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts-side-bar.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u453625278/domains/kamssamock.com/public_html/resources/views/broadcast-messages/index.blade.php ENDPATH**/ ?>