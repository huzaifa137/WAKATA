                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

                                <tr>
                                    <td><?php echo e($key + 1); ?></td>

                                    <td>
                                        <strong><?php echo e($year->year_en); ?></strong>
                                    </td>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <form action="<?php echo e(route('academic.years.delete', $year->id)); ?>" method="POST"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#createYearForm').submit(function (e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('academic.years.store')); ?>",
                    type: "POST",
                    data: form.serialize(),
...
<?php echo $__env->make('layouts-side-bar.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\KAMSSA\resources\views/academic-years/index.blade.php ENDPATH**/ ?>