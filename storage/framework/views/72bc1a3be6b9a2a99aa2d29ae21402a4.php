...
<body>
    <div class="login-card">
        ...
        <form class="login-form" id="loginForm" action="<?php echo e(route('auth-user-check')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <a href="<?php echo e(url('users/school-register')); ?>" class="btn btn-register"><i class="fas fa-user-plus"></i>
            ...
            <a href="<?php echo e(url('/')); ?>" class="btn btn-secondary" style="text-decoration: none;">
...
</html><?php /**PATH /home/u453625278/domains/kamssamock.com/public_html/resources/views/users/login.blade.php ENDPATH**/ ?>