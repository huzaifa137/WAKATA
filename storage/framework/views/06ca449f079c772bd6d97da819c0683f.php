            ...
            <div class="col-12">
                <div class="card mt-5">
                    ...
                    <div class="card-header  text-white d-flex justify-content-between align-items-center"
                        ...
                        <a href="<?php echo e(route('students.add.new.student')); ?>" class="btn btn-sm" style="background-color: #287C44;">
                            <span
                 ...
                 <div class="card-body">
    <!-- Filter Form -->
    <form method="GET" action="<?php echo e(route('students.all.students')); ?>" class="mb-4">
        <div class="row g-3 align-items-end">

            <!-- House (larger) -->
            <div class="col-12 col-md-6">
                <label for="house_id" class="form-label">Filter by School:</label>
                <select name="house_id" id="house_id" class="form-control select2">
                    ...
                    <?php $__currentLoopData = $houses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $house): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($house->ID); ?>"
                            <?php echo e(request('house_id') == $house->ID ? 'selected' : ''); ?>>
                            <?php echo e($house->House); ?> - <?php echo e($house->House_AR ?? ''); ?>
            ...
            <div class="col-12 col-md-2">
                ...
                <select name="year" id="year" class="form-control select2">
                    ...
                    <?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($year->year_en); ?>" <?php echo e(request('year') == $year->year_en ? 'selected' : ''); ?>>
                            <?php echo e($year->year_en); ?> - <?php echo e($year->year_ar); ?>
            ...
            <div class="col-12 col-md-2">
                ...
                <select name="type" id="type" class="form-control select2">
                    ...
                    <option value="uce" <?php echo e(request('type') == 'uce' ? 'selected' : ''); ?>>
                        O-LEVEL (UCE)
                    </option>
                    <option value="uace" <?php echo e(request('type') == 'uace' ? 'selected' : ''); ?>>
                        A-LEVEL (UACE)
                    </option>
                    <!-- <option value="ple" <?php echo e(request('type') == 'ple' ? 'selected' : ''); ?>>
                        Primary (PLE)
                    </option> -->
                </select>
            </div>
...
<div class="col-12 col-md-2 d-flex" style="gap: 0.25rem;">
    ...
    <a href="<?php echo e(route('students.all.students')); ?>" class="btn btn-secondary flex-fill filter-action-btn">
    ...
    <?php if(request()->anyFilled(['house_id', 'year', 'type'])): ?>
        <div class="alert mb-3 text-white rounded-0" style="background-color: #287C44;">
            ...
            <?php if(request('type')): ?>
                <span class="badge mr-2 rounded-0" style="background-color: #026837;">
                    Category: <?php echo e(request('type') === 'ple' ? 'Primary (PLE)' : ucfirst(request('type'))); ?>

                </span>
            <?php endif; ?>

            <a href="<?php echo e(route('students.all.students')); ?>" class="float-right text-white">
                Clear all filters
            </a>
        </div>
    <?php endif; ?>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><?php echo e($student->EntryDate); ?></td>
                        <td>
                            <button type="button" class="btn btn-sm btn-info view-student-details"
                                ...
                                data-student-name-ar="<?php echo e($student->Student_Name_AR); ?>"
                                data-student-sex="<?php echo e($student->StudentSex); ?>"
                                data-student-sex-ar="<?php echo e($student->StudentSex_AR); ?>"
                                data-date-of-birth="<?php echo e($student->Date_of_Birth); ?>"
                                data-date-of-birth-ar="<?php echo e($student->Date_of_Birth_AR); ?>"
                                data-house="<?php echo e($student->House); ?>" data-class="<?php echo e($student->Class); ?>"
                                data-class-ar="<?php echo e($student->Class_AR); ?>"
                                data-section="<?php echo e($student->Section); ?>"
                                data-admission-no="<?php echo e($student->admnno); ?>"
                                data-admission-year="<?php echo e($student->admnyr); ?>"
                                data-entry-date="<?php echo e($student->EntryDate); ?>"
                                data-state="<?php echo e($student->state); ?>"
                                data-district="<?php echo e($student->District); ?>"
                                data-district-ar="<?php echo e($student->District_AR); ?>"
                                data-fathers-contact="<?php echo e($student->Fatherscontact); ?>"
                                data-mothers-contact="<?php echo e($student->MothersContact); ?>"
                                data-guardians-contact="<?php echo e($student->GuardiansContact); ?>"
                                data-students-address="<?php echo e($student->StudentsAddress); ?>"
                                data-fathers-address="<?php echo e($student->FathersAddress); ?>"
                                data-mothers-address="<?php echo e($student->MothersAddress); ?>"
                                data-father-status="<?php echo e($student->FatherStatus); ?>"
                                data-mother-status="<?php echo e($student->MotherStatus); ?>"
                                data-is-orphan="<?php echo e($student->IsOrphan); ?>"
                                data-guardian-name="<?php echo e($student->GuardianName); ?>"
                                data-guardian-relationship="<?php echo e($student->GuardianRelationship); ?>"
                                data-guardians-job="<?php echo e($student->GuardiansJob); ?>"
                                data-disabilities="<?php echo e($student->Disabilities); ?>"
                                data-chronic-diseases="<?php echo e($student->ChronicleDiseases); ?>"
                                data-student-nationality="<?php echo e($student->StudentsNationality); ?>"
                                data-student-citizenship="<?php echo e($student->StudentsCitizenship); ?>"
                                data-father-nationality="<?php echo e($student->FathersNationality); ?>"
                                data-father-citizenship="<?php echo e($student->FathersCitizenship); ?>"
                                data-mother-nationality="<?php echo e($student->MothersNationality); ?>"
                                data-mother-citizenship="<?php echo e($student->MothersCitizenship); ?>"
                                data-guardian-nationality="<?php echo e($student->GuardiansNationality); ?>"
                                data-guardian-citizenship="<?php echo e($student->GuardiansCitizenship); ?>"
                                <?php if($student->house): ?> data-house-name="<?php echo e($student->house->House); ?>"
                                data-house-location="<?php echo e($student->house->Location); ?>"
                                data-house-number="<?php echo e($student->house->Number); ?>" <?php endif; ?>>
    ...
    <div class="d-flex justify-content-between align-items-center mt-2">
        <div>
            <small>Showing <?php echo e($students->firstItem()); ?> to <?php echo e($students->lastItem()); ?> of
                <?php echo e($students->total()); ?> students</small>
        </div>
        <div>
            <small>Page <?php echo e($students->currentPage()); ?> of <?php echo e($students->lastPage()); ?></small>
        </div>
    </div>
</div>
                </div>
...
<?php echo $__env->make('layouts-side-bar.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\KAMSSA\resources\views/student/all-students.blade.php ENDPATH**/ ?>