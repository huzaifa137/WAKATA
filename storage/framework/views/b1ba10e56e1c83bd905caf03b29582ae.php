            ...
            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                <div class="card bg-primary">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(url('students/all-students')); ?>" class="btn text-white"
                            style="background-color: #16c53c;">
                            <i class="fas fa-users text-white"></i> All Students
                        </a>
                    </div>
                    <div class="card-body bg-light">
                        <form id="createStudentForm" method="POST" action="<?php echo e(route('students.store')); ?>">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="Admission_Year" id="year" class="form-control select2" required>
                                        ...
                                        <?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($year->year_en); ?>"><?php echo e($year->year_en); ?> - <?php echo e($year->year_ar); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
        ...
        $(document).ready(function () {
            ...
            function updateStudentID() {
                ...
                if (schoolId && category && year) {
                    $.ajax({
                        url: '<?php echo e(route('students.generate-id')); ?>',
                        data: {
                            school_id: schoolId,
                            category: category,
                            year: year
...
<?php $__env->startSection('js'); ?>
    ...
    <script></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts-side-bar.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u453625278/domains/kamssamock.com/public_html/resources/views/student/add-new-student.blade.php ENDPATH**/ ?>