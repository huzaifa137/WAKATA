    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-card animate-card" style="animation-delay: 0.1s;">
            <div class="welcome-left">
                ...
                <p><?php echo e($systemSettings->tagline ?? "Uganda's trusted secondary examination board"); ?></p>
            </div>
            <div class="welcome-right">
                <div class="big-number"><?php echo e($overallPassRate ?? 0); ?>%</div>
        ...
        <div class="stats-grid">
            <div class="stat-card animate-card" style="animation-delay: 0.2s;">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-number"><?php echo e(number_format($totalSchools)); ?></div>
            ...
            <div class="stat-card animate-card" style="animation-delay: 0.3s;">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-number"><?php echo e(number_format($totalExamsConducted)); ?></div>
            ...
            <div class="stat-card animate-card" style="animation-delay: 0.35s;">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-number"><?php echo e($averagePercentage); ?>%</div>
        ...
        <div class="row-cards">
            ...
            <div class="card-box animate-card" style="animation-delay: 0.4s;">
                ...
                <?php if($gradeDistribution->count()): ?>
            ...
            <div class="card-box animate-card" style="animation-delay: 0.45s;">
                ...
                <div style="margin-bottom: 20px;">
                    <div class="progress-item">
                        <div class="label"><span>Average Score</span><strong><?php echo e($averagePercentage); ?>%</strong></div>
                        <div class="progress">
                            <div class="progress-bar" style="width:<?php echo e($averagePercentage); ?>%;"></div>
                        </div>
                    </div>
                    <div class="progress-item">
                        <div class="label"><span>Pass Rate</span><strong><?php echo e($overallPassRate); ?>%</strong></div>
                        <div class="progress">
                            <div class="progress-bar" style="width:<?php echo e($overallPassRate); ?>%;"></div>
                        </div>
                    </div>
                </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $topSchools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="progress-item">
                        <div class="label">
                            <span><?php echo e($school->House); ?></span><strong><?php echo e(round($school->avg_percentage, 1)); ?>%</strong></div>
                        <div class="progress">
                            <div class="progress-bar" style="width:<?php echo e(round($school->avg_percentage, 1)); ?>%;"></div>
                        </div>
                    </div>
                ...
                <table class="table-custom">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $recentResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            ?>
                            <tr>
                                <td><strong><?php echo e($result->Student_Name ?? $result->student_id); ?></strong></td>
                                <td><?php echo e($result->category); ?></td>
                                <td><?php echo e($result->year); ?></td>
                                <td><?php echo e($result->percentage); ?>%</td>
                                <td>
                                    <span class="grade-badge <?php echo e($isFail ? 'grade-fail' : 'grade-pass'); ?>">
                                        <?php echo e($grade); ?>

                                    </span>
                                </td>
                                <td style="text-align:center;">
                                    <button class="action-btn" onclick="viewResult(<?php echo e($result->id ?? 0); ?>)">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                    <button class="action-btn" onclick="downloadResult(<?php echo e($result->id ?? 0); ?>)">
        ...
        <div class="quick-grid">
            <a href="<?php echo e(route('school.allSchools')); ?>" class="quick-card animate-card" style="animation-delay:0.6s;">
            ...
            <a href="<?php echo e(route('houses.create')); ?>" class="quick-card animate-card" style="animation-delay:0.65s;">
            ...
            <a href="<?php echo e(route('import.marks')); ?>" class="quick-card animate-card" style="animation-delay:0.7s;">
            ...
            <a href="<?php echo e(route('grading.dashboard')); ?>" class="quick-card animate-card" style="animation-delay:0.75s;">
        ...
        <div class="updates-row">
            <div class="update-item animate-card" style="animation-delay:0.8s;">
                <div class="number"><?php echo e(number_format($totalStudents)); ?></div>
            ...
            <div class="update-item animate-card" style="animation-delay:0.85s;">
                <div class="number"><?php echo e(number_format($totalExamsConducted)); ?></div>
            ...
            <div class="update-item animate-card" style="animation-delay:0.9s;">
                <div class="number"><?php echo e($overallPassRate); ?>%</div>
            ...
            <div class="update-item animate-card" style="animation-delay:0.95s;">
                <div class="number"><?php echo e(number_format($topSchools->count())); ?></div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                new Chart(ctx.getContext('2d'), {
                    type: 'doughnut',
                    data: {
                        labels: <?php echo json_encode($gradeDistribution->pluck('grade')); ?>,
                        datasets: [{
                            data: <?php echo json_encode($gradeDistribution->pluck('total')); ?>,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts-side-bar.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u453625278/domains/kamssamock.com/public_html/resources/views/dashboard.blade.php ENDPATH**/ ?>