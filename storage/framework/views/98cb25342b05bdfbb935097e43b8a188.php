                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <?php if(file_exists($photoPath)): ?>
                            <img src="<?php echo e($photoUrl); ?>?v=<?php echo e(time()); ?>" alt="Student Photo" style="
                                width: 50px;
                                height: 50px;
                                object-fit: cover;
                                border-radius: 50%;
                    ...
                    <td><?php echo e($student->Student_Name_AR); ?></td>
                    ...
                    <td class="text-center">
                        <button type="button" class="btn btn-sm view-student-details mr-1" data-toggle="modal"
                            ...
                            data-student-id="<?php echo e($student->Student_ID); ?>" data-student-name="<?php echo e($student->Student_Name); ?>"
                            data-student-name-ar="<?php echo e($student->Student_Name_AR); ?>" data-student-sex="<?php echo e($student->StudentSex); ?>"
                            data-student-sex-ar="<?php echo e($student->StudentSex_AR); ?>"
                            data-date-of-birth="<?php echo e($student->Date_of_Birth); ?>"
                            data-date-of-birth-ar="<?php echo e($student->Date_of_Birth_AR); ?>" data-house="<?php echo e($student->House); ?>"
                            data-class="<?php echo e($student->Class); ?>" data-class-ar="<?php echo e($student->Class_AR); ?>"
                            data-section="<?php echo e($student->Section); ?>" data-admission-no="<?php echo e($student->admnno); ?>"
                            data-admission-year="<?php echo e($student->admnyr); ?>" data-entry-date="<?php echo e($student->EntryDate); ?>"
                            data-state="<?php echo e($student->state); ?>" data-district="<?php echo e($student->District); ?>"
                            data-district-ar="<?php echo e($student->District_AR); ?>" data-fathers-contact="<?php echo e($student->Fatherscontact); ?>"
                            ...
                            data-father-status="<?php echo e($student->FatherStatus); ?>" data-mother-status="<?php echo e($student->MotherStatus); ?>"
                            data-is-orphan="<?php echo e($student->IsOrphan); ?>" data-guardian-name="<?php echo e($student->GuardianName); ?>"
                            data-guardian-relationship="<?php echo e($student->GuardianRelationship); ?>"
                            data-guardians-job="<?php echo e($student->GuardiansJob); ?>" data-disabilities="<?php echo e($student->Disabilities); ?>"
                            ...
                            data-birth-place="<?php echo e($student->Birth_Place); ?>" data-birth-place-ar="<?php echo e($student->Birth_Place_AR); ?>"
                            data-mothers-job="<?php echo e($student->MothersJob); ?>">
                            <i class="fa fa-eye"></i> View
                        </button>
                        <button type="button" class="btn btn-sm btn-primary edit-student-details" data-toggle="modal"
                            data-target="#editStudentModal" data-student-id="<?php echo e($student->Student_ID); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\USER\Desktop\KAMSSA\resources\views/student/partials/results.blade.php ENDPATH**/ ?>