...
<?php $__env->startSection('content'); ?>
    <div class="side-app">
        ...
        <style>
            ...
            .bg-gradient-primary {
                background: linear-gradient(0, #026837 0%, #026837 100%);
            }
            ...
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <form action="<?php echo e(route('iteb.exam.statistics')); ?>" method="GET">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="year" class="form-select select2" required>
                                        ...
                                        <?php $__currentLoopData = $years ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($y); ?>" <?php echo e(isset($year) && $y == $year ? 'selected' : ''); ?>>
                                                <?php echo e($y); ?>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="category" class="form-select select2" required style="height: 38px;">
                                        ...
                                        <option value="UCE" <?php echo e(isset($category) && $category == 'UCE' ? 'selected' : ''); ?>>
                                            O-LEVEL (UCE)
                                        </option>
                                        <!-- <option value="PLE" <?php echo e(isset($category) && $category == 'PLE' ? 'selected' : ''); ?>>
                                            Primary (PLE)
                                        </option> -->
                                        <option value="UACE" <?php echo e(isset($category) && $category == 'UACE' ? 'selected' : ''); ?>>
                                            A-LEVEL (UACE)
                                        </option>
                                    </select>
                                </div>
                                ...
                                <!-- Hidden Level -->
                                <input type="hidden" name="level" id="levelInput" value="<?php echo e($level ?? ''); ?>">
                    ...
                    <div class="mb-4 pb-3 mt-4 border-bottom">
                        ...
                        <form action="<?php echo e(route('iteb.process.grading')); ?>" method="POST" id="gradingFilterForm">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row g-3">
                                    ...
                                    <select name="category" class="form-select select2" required style="height: 38px;">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>">
                                                <?php echo e($value); ?> (<?php echo e($key); ?>)
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <select name="school_number" class="form-select select2" style="height: 38px;">
                                        ...
                                        <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($code); ?>" title="<?php echo e($name); ?> (<?php echo e($code); ?>)">
                                                <?php echo e(Str::limit($name, 30)); ?> (<?php echo e($code); ?>)
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                    ...
                    <div class="row mt-4 pt-3 border-top">
                        <div class="col-md-3 col-6">
                            <div class="bg-light p-2 rounded text-center">
                                ...
                                <h6 class="mb-0"><?php echo e(count($schools ?? [])); ?></h6>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="bg-light p-2 rounded text-center">
                                <small class="text-muted">Categories</small>
                                <h6 class="mb-0"><?php echo e(count($categories ?? [])); ?></h6>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="bg-light p-2 rounded text-center">
                                <small class="text-muted">Years Active</small>
                                <h6 class="mb-0"><?php echo e(count($years ?? [])); ?></h6>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="bg-light p-2 rounded text-center">
    ...
    <script>
        ...
        document.querySelector('form[action="<?php echo e(route('iteb.exam.statistics')); ?>"]').addEventListener('submit', function (e) {
            e.preventDefault();
...
<?php echo $__env->make('layouts-side-bar.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u453625278/domains/kamssamock.com/public_html/resources/views/itemGrading/grading-summary.blade.php ENDPATH**/ ?>