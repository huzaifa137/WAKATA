...
<head>
    ...
    <meta name="description"
        content="<?php echo e($systemSettings->system_name ?? 'Kampala Integrated Secondary School Examination Bureau'); ?> — <?php echo e($systemSettings->tagline ?? 'Uganda\'s trusted secondary examination board standardizing O-LEVEL and A-LEVEL education.'); ?>">
    <title><?php echo e($systemSettings->short_name ?? 'Kamssa'); ?> —
        <?php echo e($systemSettings->system_name ?? 'Kampala Integrated Secondary School Examination Bureau'); ?>

    </title>
    <link rel="icon" type="image/png" href="<?php echo e($systemSettings->favicon_url ?? asset('asset/images/logo.png')); ?>">
...
═══════════════════════════════════════════════════════ -->
    <nav id="navbar">
        <div class="container">
            <div class="nav-inner">
                <a href="<?php echo e(route('home.page')); ?>" class="nav-logo">
                    <img src="<?php echo e($systemSettings->logo_url ?? asset('asset/images/logo.png')); ?>"
                        alt="<?php echo e($systemSettings->short_name ?? 'Kamssa'); ?> Logo">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="<?php echo e(route('users.login')); ?>" class="nav-cta">Portal Login</a></li>
                </ul>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <a href="#faq">FAQ</a>
        <a href="<?php echo e(route('users.login')); ?>">Portal Login →</a>
    </div>
...
═══════════════════════════════════════════════════════ -->
    <section class="hero">
        ...
        <div class="container hero-content">
            ...
            <p class="hero-motto">
                <?php echo e($systemSettings->system_name ?? 'Kampala Integrated Secondary School Examination Bureau'); ?></p>
            <p class="hero-desc">
                <?php echo e($systemSettings->short_name ?? 'Kamssa'); ?> standardizes, administers and certifies
            ...
            <div class="hero-buttons">
                <a href="<?php echo e(route('users.login')); ?>" class="btn-gold">
            ...
            <div class="about-grid">
                ...
                <div class="about-visual reveal">
                    <div class="about-main-card">
                        ...
                        <p><?php echo e($systemSettings->short_name ?? 'Kamssa'); ?> upholds the highest
    ...
    <footer>
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-brand">
                    <div class="footer-logo">
                        <img src="<?php echo e($systemSettings->logo_url ?? asset('asset/images/logo.png')); ?>"
                            alt="<?php echo e($systemSettings->short_name ?? 'Kamssa'); ?> Logo">
                        <strong><?php echo e($systemSettings->system_name ?? 'Kampala Integrated Secondary School Examination Bureau'); ?></strong>
                    </div>
                ...
                <div class="footer-col">
                    <h4>Portal</h4>
                    <ul>
                        <li><a href="<?php echo e(route('users.login')); ?>">Admin Login</a></li>
                        <li><a href="<?php echo e(route('users.login')); ?>">School Login</a></li>
                        <li><a href="<?php echo e(route('users.login')); ?>">Check Results</a></li>
                        <li><a href="<?php echo e(route('coming.soon')); ?>">Techsate.com</a></li>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                ...
                <p>Designed & developed by <a href="<?php echo e(route('coming.soon')); ?>">Techsate.com</a></p>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH /home/u453625278/domains/kamssamock.com/public_html/resources/views/home-page.blade.php ENDPATH**/ ?>