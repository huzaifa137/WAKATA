       ...
       are many papers, so boxes never stack vertically */
            ...
            <div class="card shadow-lg border-0">
                <div class="card-header text-white d-flex justify-content-between align-items-center"
                    ...
                    <h4 class="mb-0">
                        <i class="fa fa-school me-2"></i> School NAME - <?php echo e($schoolName ?? 'N/A'); ?>

                    </h4>
                    <span class="badge bg-light text-dark">
                        <i class="fa fa-users me-1"></i> <?php echo e($records->count()); ?> Students
                    </span>
                </div>
                    ...
                    <?php if($records->count() > 0): ?>
                        ...
                        <div class="subject-tabs-wrapper">
                            <div class="subject-tabs" id="subjectTabs">
                                <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <div class="subject-tab <?php echo e($index === 0 ? 'active' : ''); ?>"
                                        data-subject-id="<?php echo e($subject->md_id); ?>" data-subject-name="<?php echo e($subject->md_name); ?>">
                                        <div class="tab-content">
                                            <div class="tab-header">
                                                <div class="subject-info">
                                                    <div class="subject-name"><?php echo e($subject->md_name); ?></div>
                                                </div>
                                                <div class="tab-status-badge">
                                                    ...
                                                    <?php elseif($unsavedCount > 0): ?>
                                                        <span class="pending-badge">
                                                            <i class="fa fa-clock"></i> <?php echo e($unsavedCount); ?>
                                            ...
                                            <div class="stats-row">
                                                <span>
                                                    <i class="fa fa-save"></i> <?php echo e($savedCount); ?>/<?php echo e($subjectStudentCount); ?>

                                                    saved
                                                </span>
                                                <span>
                                                    <i class="fa fa-percent"></i> <?php echo e(round($progressPercent)); ?>%
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="formsContainer">
                            <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="tab-pane <?php echo e($index === 0 ? 'active' : ''); ?>" id="subject-form-<?php echo e($subject->md_id); ?>"
                                    data-subject-id="<?php echo e($subject->md_id); ?>">

                                    <form method="POST" action="<?php echo e(route('iteb.save.marks')); ?>" class="subject-form"
                                        data-subject-id="<?php echo e($subject->md_id); ?>">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="subject_id" value="<?php echo e($subject->md_id); ?>">

                                        <div class="card shadow-sm border-0 mb-3">
                                            <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                                <h5 class="mb-0">
                                                    <i class="fa fa-book me-2"></i> <?php echo e($subject->md_name); ?>

                                                    <small class="text-muted ms-2">(<?php echo e($subjectStudentCount); ?>

                                                        students)</small>
                                                </h5>
                                                <div class="subject-status">
                                                    <span
                                                        class="save-indicator <?php echo e($isComplete ? 'saved' : 'unsaved'); ?>"></span>
                                                    <span
                                                        class="saved-count"><?php echo e($savedCount); ?></span>/<?php echo e($subjectStudentCount); ?>
                                                ...
                                                <div class="mb-3">
                                                    <div class="subject-search-box">
                                                        ...
                                                        <span class="search-result-count">
                                                            <span class="count-number"><?php echo e($subjectStudentCount); ?></span> students
                                                        </span>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th width="35%">
                                                                    ...
                                                                    <?php else: ?>
                                                                        Marks
                                                                        (out of
                                                                        <?php echo e(rtrim(rtrim(number_format($subject->paper_max_scores[1] ?? 100, 2, '.', ''), '0'), '.')); ?>)
                                                                    <?php endif; ?>
                                                                </th>
                                                            ...
                                                            <?php $__currentLoopData = $subjectRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <tr
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <small class="text-muted"><?php echo e($record->Student_ID); ?></small>
                                                                    ...
                                                                    <td>
                                                                        <?php if($subject->total_papers > 1): ?>
                                                                            <div class="d-flex align-items-end paper-inputs-group"
                                                                                data-student="<?php echo e($record->Student_ID); ?>">
                                                                                <?php for($p = 1; $p <= $subject->total_papers; $p++): ?>
                                                                                    <?php if(!is_null($subject->allowed_papers) && !in_array($p, $subject->allowed_papers)) continue; ?>
                                                                                    <?php
                                                                                    ...
                                                                                    <div>
                                                                                        <input type="number"
                                                                                            name="marks[<?php echo e($record->Student_ID); ?>][<?php echo e($p); ?>]"
                                                                                            class="form-control mark-input paper-input <?php echo e($hasMark ? 'saved' : ''); ?>"
                                                                                            placeholder="P<?php echo e($p); ?>"
                                                                                            data-student="<?php echo e($record->Student_ID); ?>"
                                                                                            data-paper="P<?php echo e($p); ?>" data-max="<?php echo e($paperMax); ?>"
                                                                                            data-original="<?php echo e($paperValue); ?>"
                                                                                            value="<?php echo e(old('marks.' . $record->Student_ID . '.' . $p, $paperValue)); ?>"
                                                                                            min="0" max="<?php echo e($paperMax); ?>" step="1">
                                                                                        <small class="text-muted d-block text-center"
                                                                                            style="font-weight:Bold;">P<?php echo e($p); ?>

                                                                                            <?php if($paperMax != 100): ?>
                                                                                                /<?php echo e(rtrim(rtrim(number_format($paperMax, 2, '.', ''), '0'), '.')); ?>
                                                                                ...
                                                                                <div class="paper-avg-box">
                                                                                    <span class="badge text-white bg-secondary avg-badge">
                                                                                        Avg: <?php echo e($markValue !== '' ? $markValue : '—'); ?>

                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                        <?php else: ?>
                                                                            <?php $singleMax = (float) ($subject->paper_max_scores[1] ?? 100); ?>
                                                                            <input type="number" name="marks[<?php echo e($record->Student_ID); ?>]"
                                                                                class="form-control mark-input single-paper-input <?php echo e($markValue !== '' ? 'saved' : ''); ?>"
                                                                                placeholder="Out of <?php echo e(rtrim(rtrim(number_format($singleMax, 2, '.', ''), '0'), '.')); ?>"
                                                                                data-student="<?php echo e($record->Student_ID); ?>"
                                                                                data-max="<?php echo e($singleMax); ?>"
                                                                                data-original="<?php echo e($studentPapers[1] ?? $markValue); ?>"
                                                                                value="<?php echo e(old('marks.' . $record->Student_ID, $studentPapers[1] ?? $markValue)); ?>"
                                                                                min="0" max="<?php echo e($singleMax); ?>" step="1">
                                                                        <?php endif; ?>
                                                                    </td>
                                                                    <td>
                                                                        <?php if($markValue !== ''): ?>
                                                                            <span class="badge bg-success">Saved
                                                                                (<?php echo e($markValue); ?>)
                                                                            </span>
                                                                        <?php else: ?>
                                            ...
                                            <div class="card-footer bg-light">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <button type="submit" class="btn text-white" style="background-color: #287C44;">
                                                        <i class="fa fa-save me-2"></i> Save <?php echo e($subject->md_name); ?>
...
<?php $__env->startSection('js'); ?>
    <script>
        jQuery(function($) {
            const studentIds = <?php echo json_encode($records->pluck('Student_ID'), 15, 512) ?>;
            const subjects = <?php echo json_encode($subjects->pluck('md_id'), 15, 512) ?>;
            const existingMarks = <?php echo json_encode($existingMarks, 15, 512) ?>;
            const studentNamesMap = <?php echo json_encode($studentNames, 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts-side-bar.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u453625278/domains/kamssamock.com/public_html/resources/views/itemGrading/results.blade.php ENDPATH**/ ?>